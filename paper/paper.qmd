...
* Multiple Attempts: The research team attempted to handle potential non-response issues by improving the clarity of instructions (e.g., simplifying written instructions for electronic forms), thereby reducing misinterpretations that could lead to "floor and ceiling" effects.
